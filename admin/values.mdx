...
```tsx
// Source: apps/client/src/pages/admin/values/[path].tsx:76-410
```
...
```tsx
// Source: apps/client/src/pages/admin/values/[path].tsx:200-231
```
...
```tsx
// Source: apps/client/src/pages/admin/values/[path].tsx:160-188
```
