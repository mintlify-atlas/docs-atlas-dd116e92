...
```tsx
// Source: apps/client/src/pages/admin/manage/custom-fields.tsx:27-161
```
...
```tsx
// Source: apps/api/src/controllers/admin/manage/manage-custom-fields-controller.ts:109-138
```
...
```tsx
// Source: apps/client/src/pages/admin/manage/custom-fields.tsx:103-107
```
...
```tsx
// Source: apps/api/src/controllers/admin/manage/manage-custom-fields-controller.ts:62-66
```
